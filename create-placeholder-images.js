...
const placeholders = {
  'public/assets/img/home/hero.jpg': '<svg width="1920" height="1080" xmlns="http://www.w3.org/2000/svg"><rect width="100%" height="100%" fill="#2c3e50"/><text x="50%" y="50%" font-size="40" fill="white" text-anchor="middle">Luxury Hotel Hero Image</text></svg>',
